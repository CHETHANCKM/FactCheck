...
public class comments_activity_r extends AppCompatActivity {
    ...
    public void onBackPressed(){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            Intent i = new Intent(comments_activity_r.this, j_home.class);
            startActivity(i);
        } else {
            Intent i = new Intent(comments_activity_r.this, j_home.class);
            startActivity(i);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comments_r);
        ...
        else
        {
            ...
            try {
                DocumentReference documentReference = db.collection("Readers").document(currentuseremail);
                documentReference.addSnapshotListener(comments_activity_r.this, new EventListener<DocumentSnapshot>() {
                    @Override
    ...
    private void postcomment() {
        ...
        reference.child(timestamp).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(comments_activity_r.this, "Commented", Toast.LENGTH_SHORT).show();
                updatecommnetcount();
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(comments_activity_r.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
