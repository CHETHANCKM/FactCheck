...
import com.betalabs.factcheck.comments_activity_r;
...
public class adapter_post_r extends RecyclerView.Adapter<adapter_post_r.Myholder> {
    ...
    public adapter_post_r(Context context, List<new_post> postList) {
    ...
    public void onBindViewHolder(final Myholder myholder, final int i) {
        ...
        myholder.comment_post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent (v.getContext(), comments_activity_r.class);
